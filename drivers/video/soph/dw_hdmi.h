#ifndef __SOPH_HDMI_H__
#define __SOPH_HDMI_H__
...
struct dw_hdmi_phy_ops {
	int (*init)(struct soph_connector *conn, struct dw_hdmi *hdmi, void *data);
	void (*disable)(struct soph_connector *conn, struct dw_hdmi *hdmi, void *data);
	enum drm_connector_status (*read_hpd)(struct dw_hdmi *hdmi,
					      void *data);
	void (*mode_valid)(struct soph_connector *conn, struct dw_hdmi *hdmi, void *data);
};
