#ifndef __ATHENA2_REG_H__
#define __ATHENA2_REG_H__

#define TOP_BASE        0x28100000
#define SYS_CTRL_BASE   TOP_BASE
#define PINMUX_BASE     SYS_CTRL_BASE
#define WATCHDOG_BASE   (TOP_BASE + 0x00010000)
#define RTC_BASE	0x05026000

#define SPI_NAND_REG_BASE 0x290d0000
#define SPI_NAND_TX_DATA_BASE 0x290d0060
#define SPI_NAND_RX_DATA_BASE 0x290d0064
...
/* rst */
#define REG_SOFT_RST        (TOP_BASE + 0x3000)
#define BIT_SOFT_RST_SDIO   BIT(14)
#define BIT_SOFT_RST_NAND   BIT(12)
...
// #define OTP3_CONFIG_BASE        (CRYPTO_SIDE_OTP_BASE + 0x100)
// #define OTP2_CONFIG_BASE        (OTP3_CONFIG_BASE + 0x100)
// #define OTP_USB_XTAL_PHY 		(OTP2_CONFIG_BASE + 0x14)
#define OTP_USB_XTAL_PHY 		0x27102114
...
/* usb */
#define USB_SUBSYS_BASE     0x39000000
...
/* AXI SRAM */
#define TPU_SRAM_BASE 0x25000000
#define TPU_SRAM_SIZE 0x50000
...
/* from fsbl/plat/ATHENA2/include/platform_def.h struct _time_records { ... } */
...
#define CV_TOP_WDT_VAL      0x4

#define UBOOT_VERSION_BASE  0x250501c0

#endif /* __ATHENA2_REG_H__ */
