...
#ifndef __ATHENA2_FPGA_H__
#define __ATHENA2_FPGA_H__
...
/********************************************************************************/
	...
	#define CONFIG_RAMBOOTICOMMAND	"setenv bootargs console=$consoledev,$baudrate $othbootargs;mmc dev 0;fatload mmc 0:1 0x104000000 Image;fatload mmc 0:1 0x105000000 boot.cpio.gz.img;fatload mmc 0:1 0x106000000 athena2_fpga.dtb;" \
				"echo run Rambooti...;" \
				"if test $? -eq 0; then " \
