...
#ifndef __ATHENA2_PALLADIUM_H__
#define __ATHENA2_PALLADIUM_H__
...
#define ATHENA2_FPGA_PALLDIUM_ENV 1
#endif

// #define CONFIG_SYS_TEXT_BASE		0x100040000
#define CONFIG_SYS_INIT_SP_ADDR         (CONFIG_SYS_SDRAM_BASE + 0x03f00000)

#define CONFIG_SYS_BOOTM_LEN (64 << 20)      /* Increase max gunzip size */

/* default address for bootm command without arguments */
#define CONFIG_SYS_LOAD_ADDR		0x104000000
...
#define CONFIG_SYS_NS16550_CLK		153600
...
#define CONFIG_SYS_BOOTMAPSZ	0x40000000		//1G
#endif
/* Physical Memory Map */
...
/********************************************************************************/
	...
	#define CONFIG_BOOTCOMMAND	"run rambooti || run ramboot"
	...
	#define CONFIG_RAMBOOTICOMMAND	"setenv bootargs console=$consoledev,$baudrate $othbootargs;" \
				"echo run Rambooti...;" \
				"if test $? -eq 0; then " \
