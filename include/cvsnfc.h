...
#define CVI_SYSDMA_REMAP_BASE	(TOP_BASE + 0x154)
...
#define BIT_REG_TRX_TIME_WAIT(x)    ((x) << 8)
...
#define BIT_REG_TRX_DATA_SIZE(x)    ((x) << 16)
...
#define BIT_REG_RSP_DLY_OW_VAL              (0x01 << 8)
#define BIT_REG_RSP_NEG_SEL                 (0x01 << 12)
#define BIT_REG_DLY_SEL(x)                  ((x) << 16)
